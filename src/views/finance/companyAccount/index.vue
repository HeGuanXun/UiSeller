  ...
  <div style="height: 100%;">
    ...
    <el-table style="margin-left: 15px;"
      ...
      <el-table-column
              ...
              type="index"
              width="50"/>
      <el-table-column :label="$t('account.name')" sortable prop="platformBankAccountOwner" width="150">
      ...
      <el-table-column :label="$t('account.Account_number')" sortable prop="platformBankAccountNum" width="200">
        <template slot-scope="scope">
          <div slot="reference" class="name-wrapper">
      ...
      <el-table-column :label="$t('account.Account_opening_bank')" sortable prop="platformBank" width="200">
        <template slot-scope="scope">
          <div slot="reference" class="name-wrapper">
      ...
      <el-table-column :label="$t('account.Account_bank')" sortable prop="platformBankBranch" width="274">
        <template slot-scope="scope">
          <div slot="reference" class="name-wrapper">
      ...
      <el-table-column :label="$t('account.Account_function')" sortable prop="platformBankAccountFunction" width="274">
        <template slot-scope="scope">
          <div slot="reference" class="name-wrapper">
      ...
      <el-table-column :label="$t('account.Account_type')" sortable prop="platformBankAccountType">
        <template slot-scope="scope">
          <div slot="reference" class="name-wrapper">
      ...
      <el-table-column fixed="right"  :label="$t('account.operation')"  width="220">
        <template slot-scope="scope">
          <el-button
          ...
          >
          <el-popconfirm
                  :confirmButtonText="$t('account.OK')"
                  :cancelButtonText="$t('account.cancel')"
                  icon="el-icon-info"
                  iconColor="red"
                  :title="$t('account.delete')"
                  @onConfirm="doDelete(scope.row.platformBankAccountId)"
          >
    ...
    <!--add-->
    <el-dialog :visible.sync="isShow" width="565px"
